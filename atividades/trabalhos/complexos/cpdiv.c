...
Complex div_complex(const Complex *complex1, const Complex *complex2)
{
  ...
  double den = complex2->real * complex2->real + complex2->img * complex2->img;

  result.real = (complex1->real * complex2->real + complex1->img * complex2->img) / den;
  result.img = (complex1->img * complex2->real - complex1->real * complex2->img) / den;
...
int main(int argc, char *argv[])
{
  ...
  Complex result = div_complex(&complex1, &complex2);
