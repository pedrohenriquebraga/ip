...
Complex le_complex(const char *nome_arquivo)
{
...
void salva_complex(const char *nome_arquivo, const Complex *complex)
{
...
Complex mult_complex(const Complex *complex1, const Complex *complex2)
{
  Complex result = {{'C', 'P'}, 0.0, 0.0};
  result.real = complex1->real * complex2->real - complex1->img * complex2->img;
  result.img = complex1->real * complex2->img + complex1->img * complex2->real;
  return result;
}
...
int main(int argc, char *argv[])
{
  ...
  Complex result = mult_complex(&complex1, &complex2);
